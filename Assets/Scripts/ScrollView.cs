...
public class ScrollView : MonoBehaviour
{
    ...
    void GetFileList()
    {
     //   FileNameList = new List<string>(MazeData.MazeFile.Keys);   //fix for  new MapData.MapFile.Keys
    }
    public void ButtonClicked(string str)
    {
      //  MazeData.LOAD = true;                             //fix  no implement load a old game  so need to Load game data 
