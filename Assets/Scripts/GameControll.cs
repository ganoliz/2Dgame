...
public class GameControll : MonoBehaviour
{
  ...
  //  [SerializeField] private GameObject text_start;   //開始的劇情
  //  [SerializeField] private GameObject text_start2;
  //  [SerializeField] private GameObject text_end;   //結束的劇情

    static int text=1;  //UI的end_text跟通關完成間的判斷變數(甚麼時候hide end_text)
   ...
   /*     startPoint = new Vector3(-(MazeSizeX - 1) * WallScale / 2, 0, -(MazeSizeY - 1) * WallScale / 2);
    ...
    public void Restart()
    {
      ...
      //  CreatePlayer(startPoint);
        ...
        timer.TimeStop();
        timer.TimeStart();
        text = 1;      //UI的end_text跟通關完成間的判斷變數(甚麼時候hide end_text)
